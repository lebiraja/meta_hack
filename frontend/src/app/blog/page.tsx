...
export default function BlogPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      ...
      {content && (
        <section id="article" className="relative bg-slate-50 py-20 md:py-28">
          ...
          <div className="mx-auto max-w-3xl px-6">
            ...
            >
              ...
              <div className="mx-auto mt-4 h-px w-16 bg-gradient-to-r from-transparent via-indigo-400 to-transparent" />
            </motion.div>
